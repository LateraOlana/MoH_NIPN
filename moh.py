...
with col0:
    select = st.selectbox('Select Analysis:',('National','Tigray'	,'Afar',	'Amhara',	'Oromia',	'Somali',	'Benishangul-Gumuz',	'SNNP',	'Gambella',	'Harar',	'Dire Dawa',	'Addis Ababa'))
    ...
    if select == 'Addis Ababa':
        st.write("Under construction....")
st.write("If the result of the simulation is NaN, that means the projected value is close to zero.")